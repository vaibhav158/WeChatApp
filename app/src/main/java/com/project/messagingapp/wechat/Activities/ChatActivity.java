...
import com.project.messagingapp.wechat.Adapters.MessagesAdapter;
import com.project.messagingapp.wechat.Models.Message;
import com.project.messagingapp.wechat.R;
import com.project.messagingapp.wechat.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
        ...
        binding.sendBtn.setOnClickListener(v -> {
            ...
            database.getReference().child("chats")
                    ...
                    .setValue(message).addOnSuccessListener(aVoid -> {
                        senderUsername= message.getSenderId();
                        database.getReference().child("chats")
                                .child(receiverRoom)
                                .child("messages")
                                .child(randomKey)
    ...
    private void sendNotification(String message) {
        ...
        try{
            ...
            jsonObject1.put("title", senderUsername );
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST,URL, jsonObject, response -> {
                ...
                public Map<String, String> getHeaders() {
                    ...
                    map.put("authorization", "key=AAAA7DOkeLo:APA91bFb2N7wxAANTztOwPHg-tYYWHX5SfqtukmiZ5u-0i311SYnEwcgXLGbaWP3olZi3L1MjBw0bcHKuoyGk6XV-lo6EeXfJKYY5WZa-8427h5-rNdwNfd4L3Kz4x66cqrTfOtx2zLU");
                    return map;
                }
            };
